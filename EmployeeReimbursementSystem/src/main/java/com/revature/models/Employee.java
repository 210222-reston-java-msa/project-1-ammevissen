...
public Employee(int userId, String username, String firstName, String lastName, String email, int roleId) {
	super();
	this.userId = userId;
...
public String toString() {
	return "Employees [userId=" + userId + ", username=" + username + ", firstName="
